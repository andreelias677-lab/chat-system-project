...
# نحصل على المنفذ المطلوب من خدمة الاسم بدل كتابته مباشرة بالكود.
# السيرفر يستمع على كل الواجهات (0.0.0.0) لكنه يستخدم نفس رقم المنفذ
# المسجَّل باسم الخدمة "chat-server" حتى يبقى متوافقاً مع ما يبحث عنه الكلاينت.
_, _SERVICE_PORT = resolve(SERVICE_NAME)
